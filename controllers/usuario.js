const {response} = require('express'); // Importa la función `response` 0desde el módulo express
const bcrypt = require('bcryptjs'); // Importa la librería bcryptjs para el cifrado de contraseñas
// Importar modelos
const Usuario = require('../modules/usuario'); // Importa el modelo 

// Controlador para la solicitud GET a la ruta de usuarios
const usuariosGet = async (req, res = response) => {
    const body = req.query; // Extrae los parámetros de la consulta
    const {q, id_reserva, page= 1, limit} = req.query; // Extrae los parámetros de la consulta
